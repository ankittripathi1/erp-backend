...
export class AcademicYearsService {
  ...
  async update(id: number, updateAcademicYearDto: UpdateAcademicYearDto) {
    ...
    if (updateAcademicYearDto.start_date) data.start_date = new Date(updateAcademicYearDto.start_date);
    if (updateAcademicYearDto.end_date) data.end_date = new Date(updateAcademicYearDto.end_date);
